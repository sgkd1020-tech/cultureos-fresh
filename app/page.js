                      ...
                      >
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-4">
                          <div className="glass rounded-lg p-2.5">
                            <div className="text-xs text-platinum-600 mb-0.5">Rights / yr</div>
                            <div className="text-white font-bold text-sm">{formatM(sim.partnership.annualRightsFee)}</div>
                          </div>
                          <div className="glass rounded-lg p-2.5">
                            <div className="text-xs text-platinum-600 mb-0.5">Activation / yr</div>
                            <div className="font-bold text-sm" style={{ color: sim.brand.color }}>{formatM(sim.partnership.annualActivationAndMedia)}</div>
                          </div>
                        </div>
