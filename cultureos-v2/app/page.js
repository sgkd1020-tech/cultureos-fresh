...
export default function Home() {
        ...
        >
          <div className="card-premium rounded-2xl p-8">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-platinum-400 mb-2">
                  Username
                </label>
                <input
                  type="text"
  ...
  return (
    <div className="min-h-screen bg-gradient-premium relative">
      <div className="border-b border-platinum-800 bg-noir-900/80 backdrop-blur-sm sticky top-0 z-40">
        ...
        <AnimatePresence mode="wait">
          ...
          {activeTab === 'predict' && (
            <motion.div
              ...
              className="space-y-6"
            >
              {/* Header — aggregate stats across the full cohort */}
              <div className="card-premium rounded-2xl p-8">
